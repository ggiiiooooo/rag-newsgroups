...
Нарезка текста на чанки по абзацам с ограничением длины и overlap.
"""
...
def split_paragraphs(text: str) -> list[str]:
    """Разбивает текст на непустые абзацы (по пустой строке)."""
...
def load_documents(path: Path) -> list[dict]:
    """Читает JSONL-файл (documents.jsonl или chunks.jsonl) в список словарей."""
    documents = []
